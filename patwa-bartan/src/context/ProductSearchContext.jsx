    ...
    const fetchProducts = async () => {
      try {
        ...
        for (const category of requiredCategories) {
          ...
          if (snapshot.exists()) {
            productData[category] = Object.values(snapshot.val().map(product => ({
              id: product.id, // Ensure 'id' is present in product data
              title: product.Title, // Assuming there is a 'title' field
              metal: product.Metal, // Assuming there is a 'metal' field
              brand: product.Brand // Assuming there is a 'brand' field
            })) || []);
          } else {
